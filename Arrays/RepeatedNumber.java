...
public class RepeatedNumber {
    public static ArrayList<Integer> repeatedNumber(int[] A2) {
        Arrays.sort(A2);
        ...
        long actSum = 0;
        long actSquares = 0;
        long nSum = ((long)(A.size()) * (long)((A.size() + 1))) / 2;
        long nSquares = ((long)(A.size()) * (long)((A.size() + 1)) * (long)((2 * A.size() + 1))) / 6;
        long diffAB = 0;
        long sumAB = 0;
        int A1 = 0;
        int B1 = 0;
        ...
        for(int i = 0; i < A.size(); i++){
            actSum += (long)(A.get(i));
            actSquares += (long)(A.get(i)) * (long)(A.get(i));
        }
        diffAB = actSum - nSum;
        sumAB = (actSquares - nSquares) / diffAB;

        A1 = (int)(diffAB + sumAB) / 2;
        B1 = (int)sumAB - A1;
        result.add(A1);
        result.add(B1);
        return result;
